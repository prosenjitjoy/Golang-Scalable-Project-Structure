...
func GetDatabase(databaseURI string) driver.Database {
	...
	db_exists, err := client.DatabaseExists(context.TODO(), "bulletproof")
	if err != nil {
	...
	if db_exists {
		...
		db, err = client.Database(context.TODO(), "bulletproof")
		if err != nil {
			log.Fatal("Failed to create database:", err)
		}
	} else {
		db, err = client.CreateDatabase(context.TODO(), "bulletproof", nil)
		if err != nil {
			log.Fatal("Failed to create database:", err)
		}
	}
